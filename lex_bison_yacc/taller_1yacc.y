...
%%
	...
	FUNCION_PRINCIPAL: TIPO_DATO P_RESERVADA A_PARENTESIS C_PARENTESIS A_LLAVE EXPRESIONES P_RETURN NUMERO C_LLAVE
		|P_RESERVADA A_PARENTESIS C_PARENTESIS A_LLAVE EXPRESIONES C_LLAVE
		|TIPO_DATO P_RESERVADA A_PARENTESIS P_ARGUMENTOS C_PARENTESIS A_LLAVE EXPRESIONES P_RETURN NUMERO C_LLAVE
		|P_RESERVADA A_PARENTESIS P_ARGUMENTOS C_PARENTESIS A_LLAVE EXPRESIONES C_LLAVE|P_RESERVADA A_PARENTESIS C_PARENTESIS A_LLAVE  C_LLAVE;

	EXPRESIONES:P_RESERVADA | DECLARACIONES_VARIABLES | BUCLE_FOR | P_RETURN | NUMERO | LETRA |FIN_SENTENCIA;
